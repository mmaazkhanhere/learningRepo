...
const Details = ({ position, company, companyLink, time, address, work }) => {
    ...
    justify-between md:w-[80%]'>
        ...
        <motion.div
            ...
            <h3 className='capitalise font-bold text-2xl sm:text-xl xs:text-lg'>
                {position}&nbsp;
                <a target='_blank' href={companyLink} className='text-primary dark:text-primaryDark capitalise'>
                    @{company}
                </a>
            </h3>
            <span className='capitalise font-medium text-dark/75 dark:text-light/75 xs:text-sm'>
                {time}|{address}
            </span>
            ...
            <div className='w-[75%] mx-auto relative lg:w-[90%] md:w-full' ref={ref}>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                    <Details position="Software Engineer" company="Google" time={"2022-Present"}
                        ...
                        work={"Worked on a team responsible for developing new features for Google's search engine including improving the accuracy and relevance of search result"}
                    />
                    <Details position="Software Engineer" company="Google" time={"2022-Present"}
                        address={"Mountain View, CA"}
                        work={"Worked on a team responsible for developing new features for Google's search engine including improving the accuracy and relevance of search result"}
